...
function DataMap(instance, priv, GridSettings) {
  ...
  if (this.dataSource[0]) {
    ...
    this.duckSchema = this.recursiveDuckSchema(this.dataSource[0], 0);
  } else {
    this.duckSchema = {};
  }
  this.createMap();
...
DataMap.prototype.recursiveDuckSchema = function(object, level) {
  return Handsontable.helper.duckSchema(object, level);
};
...
function duckSchema(object, level) {
  var schema;
  if (level === undefined) {
    level = 0;
  }
